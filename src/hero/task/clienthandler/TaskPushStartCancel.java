...
public class TaskPushStartCancel extends AbsClientProcess {
    ...
    public void read() throws Exception {
        ...
        LogServiceImpl.getInstance().taskPushOption(player.getLoginInfo().accountID, player.getLoginInfo().username, player.getUserID(), player.getName(), pushID, 1, "\u53d6\u6d88", price);
    }
}
