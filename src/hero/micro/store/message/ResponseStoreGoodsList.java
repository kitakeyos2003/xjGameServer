...
public class ResponseStoreGoodsList extends AbsResponseMessage {
    ...
    static {
        ResponseStoreGoodsList.log = Logger.getLogger((Class) ResponseStoreGoodsList.class);
    }

    public ResponseStoreGoodsList(final PersionalStore _store) {
        this.store = _store;
    }
    ...
    protected void write() throws IOException {
        if (this.store == null || !this.store.opened) {
            this.yos.writeByte(0);
            return;
        }
        ResponseStoreGoodsList.log.info((Object) ("ResponseStoreGoodsList .. " + this.store.opened));
