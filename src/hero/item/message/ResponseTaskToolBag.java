...
public class ResponseTaskToolBag extends AbsResponseMessage {
    ...
    public ResponseTaskToolBag(final SingleGoodsBag _goodsPackage, final int[][] _shortcutKeyList) {
    ...
    protected void write() throws IOException {
        this.yos.writeBytes(SingleGoodsPackageData.getData(this.goodsPackage, true, this.shortcutKeyList, GoodsServiceImpl.getInstance().getConfig().task_tool_bag_tab_name));
    }
}
